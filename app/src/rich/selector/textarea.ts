...
//                 this.editor.cursorView.cursor.input(this.textarea.value);
//             }
//             else {
//                 //这里主要是判断当前的输入是否已同步至光标输入中，此时输入框是空的，但这是刚按下的，在按前可能还值
//                 //如果按前本身就是空的，那说明用户是想回退删除文本
//                 if (this.editor.cursorView.cursor.inputValue)
//                     this.editor.cursorView.cursor.input(this.textarea.value);
//                 else this.editor.cursorView.cursor.back();
//             }
//         }
//         else if (['ArrowLeft', 'ArrowRight', 'ArrowDown', 'ArrowUp'].includes(event.key)) {
//             this.editor.cursorView.cursor.move(event.key as any);
//         }
//         else if (event.key == 'Enter') {
//             //聚焦到输入空白处
//             this.editor.cursorView.focus();
//         }
//         else {
//             if (this.editor.cursorView.isBlank) {
...
//                     this.editor.cursorView.focus(cursor);
//                     this.editor.cursorView.cursor.input(this.textarea.value);
//                 })
//                 this.editor.render();
//             }
